...
path_data='/data/oper-hidro/VIC/Inputs/In_VIC/'
...
###################################################################################################
### A PARTIR DEL ARCHIVO DEL paso 03 (param_control_file.txt) SE DEFINEN 18 VARIABLES 
### QUE DEBE LEER ESTE SCRIPT PARA ARMAR EL ARCHIVO DE CONTROL DEL VIC
### VARIABLES: ${PART[0]} hasta ${PART[17]}
cd ${path_PF_VIC}
...
#STATEYEAR  2019    # year to save model state
#STATEMONTH 08  # month to save model state
#STATEDAY   22  # day to save model state
