...
for combinacion in {1..4}-{8..8}-{1..6}-{1..1}-{1..7}-{1..5}-{1..5}
do
rm ${path_ppal}parametros-cal8.R
rm ${path_ppal}estadisticos-cal8.R
...
cd ${path_ppal}
echo ${cal_param_1} ${cal_param_2} ${cal_param_3} ${cal_param_4} ${cal_param_5} ${cal_param_6} ${cal_param_7} >> ${path_ppal}LOG8.txt
...
###########################################################################
############################ FINALIZADO ###################################
###########################################################################" >> ${path_ppal}parametros-cal8.R
################################################################################################

Rscript ${path_ppal}'parametros-cal8.R' >> ${path_ppal}LOG8.txt
...
${path_route}rout ${path_control_rout}${control_file_route} >> ${path_ppal}LOG8.txt
...
mod.PELOT <- read.table(paste0(path.modelo, 'PELO8.day'), header = FALSE)
mod.CANOA <- read.table(paste0(path.modelo, 'CANO8.day'), header = FALSE)
mod.IRAI <- read.table(paste0(path.modelo, 'IRAI8.day'), header = FALSE)
mod.SOBER <- read.table(paste0(path.modelo, 'SOBE8.day'), header = FALSE)
mod.GARRU <- read.table(paste0(path.modelo, 'GARR8.day'), header = FALSE)
mod.PASOL <- read.table(paste0(path.modelo, 'PASO8.day'), header = FALSE)
mod.CONCO <- read.table(paste0(path.modelo, 'CONC8.day'), header = FALSE)
...
###########################################################################
############################ FINALIZADO ###################################
###########################################################################" >> ${path_ppal}estadisticos-cal8.R

###################################################################################################

Rscript ${path_ppal}'estadisticos-cal8.R' >> ${path_ppal}LOG8.txt
